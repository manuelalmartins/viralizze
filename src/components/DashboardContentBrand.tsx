...
interface Opportunity {
  ...
  hashtags: { tag: string }[];
  createdAt: string;
  brand: { name: string; companyName: string };
}
...
const DashboardContentBrand: React.FC<Props> = ({ brandId }) => {
  ...
  return (
    <div className="dashboard-content">
      <header className="dashboard-header">
        ...
        <button className="fab" onClick={openCreateModal} aria-label="Criar nova oportunidade">
          +
        </button>
      </header>
        ...
        <ul className="opportunity-list">
          ...
          {opportunities.map((opp) => (
            <li key={opp.id} className="opportunity-card">
              ...
              <p>
                <strong>Requisitos:</strong> {opp.requirements || 'Não especificado'}
              </p>
              ...
              <button className="view-applicants-btn" onClick={(e) => openApplicantsModal(opp.id, e)}>
                Ver Candidatos
              </button>
...
export default DashboardContentBrand;
